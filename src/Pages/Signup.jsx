      ...
      <div className="bg-[rgb(30,40,60)] p-8 rounded-xl shadow-lg w-96">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative">
            ...
            <button
              type="button"
              className="absolute right-20 top-2 text-gray-300 hover:text-white"
            ...
            <button
              type="button"
              className="absolute right-3 top-2 bg-purple-500 px-3 py-1 rounded-lg text-white hover:bg-purple-600"
